...
\usepackage{icomma}
\DeclareUnicodeCharacter{201C}{\quotedblbase} % you could write \glqq if you use the babel package
\DeclareUnicodeCharacter{201D}{\textquotedblleft} % you could write \grqq if you use the babel package
